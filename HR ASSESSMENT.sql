...
-- 9) Display the average of sum of the salaries and group the result with the department id. Order the result with the department id.
select avg(salary),department_id as avg_of_salary from employees group by department_id order by department_id ;

-- 10) Select the maximum salary of each department along with the department id.
